...
describe ActionRunner do
  ...
  describe '.find_class' do
    ...
    context 'namespace is not specified' do
      ...
      specify do
        expect { runner.find_class(action_string) }.to raise_error(ActionRunner::ActionNotFound,
    ...
    context 'action in not specified' do
      ...
      specify { expect { runner.find_class('test-namespace#') }.to raise_error(ActionRunner::ActionNotFound,
                                                                               /Action name is not specified/) }
    end

    context 'action which does not exist is specified' do
      specify { expect { runner.find_class('TestNamespace#Asd') }.to raise_error(ActionRunner::ActionNotFound,
